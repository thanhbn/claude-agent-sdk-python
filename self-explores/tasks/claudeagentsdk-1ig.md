...
- Mã nguồn (chỉ cho Bước 3 lấp lỗ hổng): [`query.py`](../../src/claude_agent_sdk/_internal/query.py), [`subprocess_cli.py`](../../src/claude_agent_sdk/_internal/transport/subprocess_cli.py)
...
**Giải quyết Lỗ hổng 1:** Đọc [`query.py`](../../src/claude_agent_sdk/_internal/query.py) — mô tả giao thức điều khiển:
...
**Giải quyết Lỗ hổng 2:** Đọc [`subprocess_cli.py`](../../src/claude_agent_sdk/_internal/transport/subprocess_cli.py) — mô tả streaming:
...
**Giải quyết Lỗ hổng 3:** Đọc [`query.py`](../../src/claude_agent_sdk/_internal/query.py) phần xử lý hook:
